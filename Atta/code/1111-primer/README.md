...
- 说明:
  - 筛选三千万到三千万零二百之间所有的质数.
  - 对 [v6](#v6) 进行重写, 解决线程间的竞争冲突(丑陋的解决方法).
...
- 说明:
  - 筛选三千万到三千万零二百之间所有的质数.
  - 对 [v7](#v7) 进行重写, 解决线程间的竞争冲突(规范的解决方法).
...
- 说明:
  - 筛选三千万到三千万零二百之间所有的质数.
  - 对 [v7](#v7) 进行改写, 加入互斥量的使用, 实现线程任务池.
  - 该程序为盲等版, 盲在各线程在不停的查看任务状态, 属于查询法, 改成通知法就是非盲等的了.
  - 非盲等版见 [v10](#v10).
...
- 说明:
  - 筛选三千万到三千万零二百之间所有的质数.
  - 对 [v9](#v9) 进行改写, 添加条件变量, 使程序变成通知法非盲等版.
  - 该程序为非盲等版.
...
- 代码文件：
  - [my_semaphore.h](./v11/my_semaphore.h)
  - [my_semaphore.c](./v11/my_semaphore.c)
  - [main.c](./v11/main.c)

- 说明:
  - 筛选三千万到三千万零二百之间所有的质数.
  - 对 [v6](#v6) 进行改写, 使用互斥量加条件变量达到信号量的效果.
  - 可以产生任意数量的线程, 但同一时刻最多只能存在固定个数的线程.
...
- 说明:
  - 筛选三千万到三千万零二百之间所有的质数.
  - 使用自己实现的管道对筛选质数程序进行效率优化.
  - [示例: 管道示例-池类算法](../1133-my-pipe/README.md#v1)
